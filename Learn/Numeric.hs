...
numGradientNN :: MonadLogger m => UMat -> UMat -> (Double -> m NN) -> Double -> m Double  
...
numGradientWP :: MonadLogger m => NN -> UMat -> UMat -> Int -> Int -> Int -> Double -> m Double  
...
numGradientBP :: MonadLogger m => NN -> UMat -> UMat -> Int -> Int -> Double -> m Double  
